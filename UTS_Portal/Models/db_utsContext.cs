...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Goods>(entity =>
            {
                ...
                entity.Property(e => e.Category).HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<Menus>(entity =>
            {
                ...
                entity.Property(e => e.ItemNameEn).HasDefaultValueSql("('')");

                entity.Property(e => e.ItemNameVn).HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<PreOrders>(entity =>
            {
                ...
                entity.Property(e => e.DoW).HasDefaultValueSql("((0))");
