...
namespace TaskManager.Extension
{
    public static class Utilities
    {
        ...
        public static string GetStringByFormat(DateTime? updateTime, DateTime? creationDate)
        {
            var dateTime = updateTime != null ? updateTime : creationDate;
            if (dateTime != null )
            {
                ...
                {
                    formattedDate = "Today " + dateTime?.ToString("HH:mm");
                }
                else if (dateTime?.Date == yesterday)
                {
                    formattedDate = "Yes " + dateTime?.ToString("HH:mm");
                }
                else
                {
                    formattedDate = dateTime?.ToString("MM/dd HH:mm");
                }
